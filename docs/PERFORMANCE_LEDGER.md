...
| K3 | **29.0** (16x sparks, B-scope/precision per ciprianveg's run — receipt pending from his lane) — supersedes the 18.0 anchor; his published v5-prd table pins C1 **29.81**, C2 42.00 agg, C8 87.12 agg / 136 peak at TP16+DCP8 nst6 spec (gb10-vllm kimi-k3/v5/README.md:68-79; no-spec llama tg2048 = 23.59 @d4000) | 16-rank TP16 serve, announced by @ciprianveg 2026-09-19 (announced-MEASURED: attributed claim, config/batch/hash details to be receipted into K3_PERF.md by the k3 lane; graded 'announced' until his receipts land) | — | not measured | per ciprianveg | 2026-09-19 |
