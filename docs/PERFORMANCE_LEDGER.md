...
| K3 | **29.0** (16x sparks, B-scope/precision per ciprianveg's run — receipt pending from his lane) — supersedes the 18.0 anchor | 16-rank TP16 serve, announced by @ciprianveg 2026-09-19 (announced-MEASURED: attributed claim, config/batch/hash details to be receipted into K3_PERF.md by the k3 lane; graded 'announced' until his receipts land) | — | not measured | per ciprianveg | 2026-09-19 |
