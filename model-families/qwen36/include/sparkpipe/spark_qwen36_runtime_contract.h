#ifndef SPARKPIPE_SPARK_QWEN36_RUNTIME_CONTRACT_H
#define SPARKPIPE_SPARK_QWEN36_RUNTIME_CONTRACT_H

#include <string.h>

#include "sparkpipe/spark_model_runtime.h"

static inline SparkModelRuntimeContract SparkQwen36RuntimeContract(void)
{
...
static inline SparkStatus SparkQwen36RuntimeValidateContract(
    const SparkModelRuntimeContract *contract)
{
    SparkModelRuntimeContract expected_contract;

    expected_contract = SparkQwen36RuntimeContract();
