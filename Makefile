...
build/test_model_pipeline_client_mock: tests/test_model_pipeline_client_mock.c tests/mock_model_resident_client.c $(RUNTIME_LIBRARY) $(MODEL_COMMON_LIBRARY) $(CORE_LIBRARY)
	$(CC) $(CPPFLAGS) $(CFLAGS) tests/test_model_pipeline_client_mock.c tests/mock_model_resident_client.c $(RUNTIME_LIBRARY) $(MODEL_COMMON_LIBRARY) $(CORE_LIBRARY) $(LDFLAGS) $(LDLIBS) -o $@
